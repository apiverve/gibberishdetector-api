...
namespace APIVerve.API.GibberishDetector
{
    ...
    /// <summary>
    /// Client for the GibberishDetector API
    /// </summary>
    public class GibberishDetectorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/gibberishdetector";
        ...
        public GibberishDetectorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GibberishDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GibberishDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, GibberishDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(GibberishDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(GibberishDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(GibberishDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(GibberishDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(GibberishDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(GibberishDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(GibberishDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(GibberishDetectorQueryOptions options)
        {
