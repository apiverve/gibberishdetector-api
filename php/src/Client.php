...
namespace APIVerve\Gibberishdetector;
...
/**
 * Client for the Gibberish Detector API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/gibberishdetector?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/gibberishdetector';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GibberishdetectorClient] {$message}\n";
        }
    }
}
