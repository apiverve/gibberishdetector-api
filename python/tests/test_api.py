...
class TestGibberishdetectorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = GibberishdetectorAPIClient(self.api_key)

    @patch('apiverve_gibberishdetector.apiClient.requests.get')
